...
import 'package:photo_picker_initial/screens/explore_color/know_Color_RGB.dart';
import 'package:photo_picker_initial/screens/explore_color/know_Color_shade.dart';
...
class categoryExploreColor extends StatelessWidget {
  @override
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ColorPickerDemo2()));
                  },
                  style: ButtonStyle(
                      backgroundColor:
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                            builder: (context) => MaterialColorPage()));
                  },
                  style: ButtonStyle(
                      backgroundColor:
